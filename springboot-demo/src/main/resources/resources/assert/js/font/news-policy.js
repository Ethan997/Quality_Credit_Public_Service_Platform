$(document).ready(function () {
    ...
    function getNewsList() {
        var start = 1; //从第多少条开始
        var num=0; //总条数
        var markup ="<section class='news'><div class='news-list'><article><div class='news-content'><h2 class='news-title'><a href=${contentDetailUrl} target='_blank'>${title}</a></h2></div><div class='meta'><div class='meta-author meta-date'><span>提交人：${createUser}</span><span> | </span><span>发表于：${createTime}</span></div><div class='meta-date'> </div></div></article></div></section>";
        ...
        $.ajax({
            method: 'GET',
            url: '/news/pageable?field=POLICY_AND_REGULATION_DOCUMENTS&page=' + start + '&size=10',
